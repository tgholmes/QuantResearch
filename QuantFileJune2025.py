...
StartDate = '2025-04-01' #YY-MM-DD
EndDate = '2025-06-10' #YY-MM-DD
interval = '1d' #e.g. 1m, 2m, 5m, 15m, 30m, 60m, 1d, 1wk, 1mo

#Downloading share data for a range of shares in S&P500
ShareData = {}
tickers = ['SPY'] #Add any tickers you want to analyse
...
def PerformEDA(ShareData, tickers, StartDate, EndDate, interval):
    ...
    for ticker, color in zip(tickers, colors):
        ...
        mpf.plot(data, type='candle', mav=(20), title=f'Candlestick chart for {ticker}', volume=True, style='yahoo', savefig=saveparams)
